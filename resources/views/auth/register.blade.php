            ...
            <div class="w-[500px]">
                ...
                <div class="bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 border border-white/10 shadow-2xl">
                    ...
                    <form method="POST" action="{{ route('register') }}" id="registerForm" class="space-y-6">
                        ...
                        <!-- Name -->
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">👤 {{ __('messages.name') }}</label>
                        ...
                        <!-- Password -->
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">🔒 {{ __('messages.password') }}</label>
                        ...
                        <!-- Confirm -->
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">🔒 {{ __('messages.confirm_password') }}</label>
